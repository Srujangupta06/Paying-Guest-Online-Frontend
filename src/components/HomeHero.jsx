    ...
    <section className="px-6 w-full mb-6 sm:mb-12  sm:py-0 bg-image flex flex-col items-center justify-center">
      <div className="px-2 sm:px-4 flex flex-col text-center items-center">
        ...
        <div className="text-center">
          <button className="bg-white text-black text-sm px-5 py-2 border border-white cursor-pointer mr-4">
            Find Hostels
          </button>
          <button className="bg-transparent text-white text-sm px-5 py-2 border border-white  cursor-pointer">
            List Hostel
          </button>
        </div>
      </div>
